...
class Store:
    def __init__(self, main_data, consumer_market_data, consumer_sector_data, general_industrials_sector_data,
                 general_industrials_market_data, all_companies,
                 consumer_companies,
                 general_companies, margin_of_safety, beta, year, inflation):
        self.main_data = main_data
        self.consumer_sector_data = consumer_sector_data  # sector  P/E
        self.consumer_market_data = consumer_market_data  # market P/E
        self.general_industrials_sector_data = general_industrials_sector_data  # sector  P/E
        self.general_industrials_market_data = general_industrials_market_data  # market P/E
