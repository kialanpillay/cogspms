...
def value_network():
        ...
        pe_relative_market_state = "Cheap" #get from DF
...
#         ve_model.addArc(ve_model.idFromName('FutureSharePerformance'), ve_model.idFromName('ForwardPE_current_vs_history'))
        ...
        #utilities
        #utility of Expensive _utilty
        ve_model.utility(ve_model.idFromName('utility_expensive'))[{'Expensive_e':0}]=[[-70],[0],[50]] # 3values for Future share performace, 2 for expensive decision
        ve_model.utility(ve_model.idFromName('utility_expensive'))[{'Expensive_e':1}]=[[0],[200],[0]]

          #utility of Expensive _utilty
        ve_model.utility(ve_model.idFromName('utility_value_relative_to_price'))[{'ValueRelativeToPrice':0}]=[[-70],[0],[50]] # 3values for PE relative sector, 3 for Value relative to price node
        ve_model.utility(ve_model.idFromName('utility_value_relative_to_price'))[{'ValueRelativeToPrice':1}]=[[0],[200],[0]]
        ve_model.utility(ve_model.idFromName('utility_value_relative_to_price'))[{'ValueRelativeToPrice':2}]=[[-80],[0],[60]]
        ...
        else: #(self.future_share_performance=="Expensive")
        ...
        else : #(self.pe_relative_market=="Expensive")
        ...
        else: #(self.pe_relative_sector=="Expensive"):
        ...
        else: #(self.forward_pe_current_vs_history=="Expensive")
        ...
        print('Best decision for Expensive_e: {0}'.format(ie.getBestDecisionChoice(model.idFromName('Expensive_e'))))
        print('Best decision for ValueRelativeToPrice: {0}'.format(ie.getBestDecisionChoice(model.idFromName('ValueRelativeToPrice'))))
